...
describe('Test', function(){    
  ...
  describe('# Initial Basic Values', function(){
    ...
    it('Initial score value 0', function(){
      var myCode = require('../proj.js');
      expect(myCode.score).to.equal(undefined);
    });
    it('Initial highscroe value 0', function(){
      var myCode = require('../proj.js');
      expect(myCode.highscore).to.equal(undefined);
    });
    it('Initial speed value 2000', function(){
      var myCode = require('../proj.js');
      expect(myCode.speed).to.equal(undefined);
    });
    ...
    it('Initial survival type', function(){
      var myCode = require('../proj.js');
      expect(myCode.survival).to.be.undefined;
    });
    it('Initial insane type', function(){
      var myCode = require('../proj.js');
      expect(myCode.insane).to.be.undefined;
    });
  ...
  describe('# Initial Timer Values', function(){
    it('initial time value', function(){
      var myCode = require('../proj.js');
      expect(myCode.time).to.equal(undefined);
    });
    ...
    it('Boolean two, three, four values', function(){
      var myCode = require('../proj.js');
      expect(myCode.two).to.be.undefined;
      expect(myCode.three).to.be.undefined;
      expect(myCode.four).to.be.undefined;
    });
...
//       expect(mole1top).to.be.a(undefined);
//       expect(mole1left).to.be.a(undefined);
//       expect(boom1top).to.be.a(undefined);
//       expect(boom1left).to.be.a(undefined);
//     } );
